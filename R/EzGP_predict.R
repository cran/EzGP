#' @title The Prediction Function of \code{EzGP} Model
#'
#' @description Predicts the output of the EzGP model fitted by \code{\link[EzGP]{EzGP_fit}}.
#'
#' @param X_new Matrix or vector containing the input(s) where the predictions are to be made. Each row is an input vector.
#' @param model The EzGP model fitted by \code{\link[EzGP]{EzGP_fit}}.
...
#'
#' @seealso
#' \code{\link[EzGP]{EzGP_fit}} to fit EzGP model for the datasets.\cr
#'
#' @examples
